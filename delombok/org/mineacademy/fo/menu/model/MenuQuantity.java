...
public enum MenuQuantity {
	...
	private List<MenuQuantity> compileQuantities(boolean includeDecimals) {
		...
		for (final MenuQuantity quantity : values()) if (includeDecimals || quantity.getAmountPercent() >= 1.0) available.add(quantity);
		return available;
	}

	@java.lang.SuppressWarnings("all")
	private MenuQuantity(final double amountPercent) {
