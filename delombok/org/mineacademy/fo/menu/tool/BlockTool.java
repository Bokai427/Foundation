...
public abstract class BlockTool extends Tool {
	...
	protected final void onBlockClick(final PlayerInteractEvent event) {
		...
		if (action == Action.RIGHT_CLICK_BLOCK) this.onBlockClick(player, ClickType.RIGHT, block);
		 else if (action == Action.LEFT_CLICK_BLOCK) this.onBlockClick(player, ClickType.LEFT, block);
		 else if (action == Action.RIGHT_CLICK_AIR) this.onAirClick(player, ClickType.RIGHT);
		 else if (action == Action.LEFT_CLICK_AIR) this.onAirClick(player, ClickType.LEFT);
	}
