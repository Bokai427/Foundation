...
public abstract class Button {
	...
	public static final DummyButton makeInfo(final String... description) {
		...
		lores.add(" ");
		for (final String line : description) lores.add("&7" + line);
	...
	public static final class DummyButton extends Button {
		...
		private DummyButton(final ItemStack item) {
			this.item = item;
		}
	 ...
	 */
	@java.lang.SuppressWarnings("all")
	public static void setInfoButtonMaterial(final CompMaterial infoButtonMaterial) {
	 ...
	 */
	@java.lang.SuppressWarnings("all")
	public static void setInfoButtonTitle(final String infoButtonTitle) {
