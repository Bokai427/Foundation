...
public enum CompSound {
	...
	CompSound(String... legacyNames) {
		...
		if (bukkitSound == null) for (final String legacy : legacyNames) {
		...
		for (final String legacy : legacyNames) Data.NAMES.putIfAbsent(legacy, this);
	}
	...
	public void play(@NonNull Location location, float volume, float pitch) {
		if (location == null) {
			throw new java.lang.NullPointerException("location is marked non-null but is null");
		}
	...
	public void play(@NonNull Entity entity, float volume, float pitch) {
		if (entity == null) {
			throw new java.lang.NullPointerException("entity is marked non-null but is null");
		}
		if (entity instanceof Player) {
			final Sound sound = this.getSound();
			if (sound != null) ((Player) entity).playSound(entity.getLocation(), sound, volume, pitch);
		} else this.play(entity.getLocation(), volume, pitch);
	}
	...
	public BukkitTask playRepeatedly(@NonNull Entity entity, float volume, float pitch, int repeat, int delay) {
		...
		return new BukkitRunnable() {
			...
			public void run() {
				...
				if (this.repeating-- == 0) this.cancel();
			}
	...
	public static CompSound fromSound(@NonNull Sound sound) {
		if (sound == null) {
			throw new java.lang.NullPointerException("sound is marked non-null but is null");
		}
	...
	public static CompSound fromName(@NonNull String soundName) {
		if (soundName == null) {
			throw new java.lang.NullPointerException("soundName is marked non-null but is null");
		}
	...
	public static BukkitTask playAscendingNote(@NonNull Player player, @NonNull Entity playTo, Instrument instrument, int ascendLevel, int delay) {
		...
		if (playTo == null) {
			throw new java.lang.NullPointerException("playTo is marked non-null but is null");
		}
...
class Data {
	...
	static {
		for (final Sound sound : Sound.values()) BUKKIT_NAMES.put(sound.name(), sound);
	}
}
