...
public class ASCIIUtil {
	...
	public static List<String> generate(String message, @NonNull String letterSymbols) {
		if (letterSymbols == null) {
			throw new java.lang.NullPointerException("letterSymbols is marked non-null but is null");
		}
	...
	public static List<String> generate(String message, int textHeight, @NonNull List<String> letterSymbols) {
		...
		for (int y = 0; y < textHeight; y++) {
			...
			for (int x = 0; x < imageWidth; x++) sb.append(bufferedImage.getRGB(x, y) == Color.WHITE.getRGB() ? RandomUtil.nextItem(letterSymbols) : " ");
