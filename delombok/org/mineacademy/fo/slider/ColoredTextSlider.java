...
public final class ColoredTextSlider implements Slider<String> {
	...
	@Override
	public String next() {
		if (this.currentPointer == Integer.MIN_VALUE || this.currentPointer == this.text.length()) this.currentPointer = 1 - this.width;
	...
	@java.lang.SuppressWarnings("all")
	private ColoredTextSlider(final String text) {
		this.text = text;
	}
}
