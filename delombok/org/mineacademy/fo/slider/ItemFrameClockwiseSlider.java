...
public class ItemFrameClockwiseSlider implements Slider<Map<Integer, ItemStack>> {
	...
	public Map<Integer, ItemStack> next() {
		...
		for (int index = 0; index < this.frameSize; index++) {
			...
			if (row == 0 || row == rowCount - 1 || column == 1 || column == 9) items.put(index, this.fillerItem);
		}
		if (this.currentPointer < 8) this.currentPointer++;
		 else if (this.currentPointer == 8) this.currentPointer = 17;
		 else if (this.currentPointer <= this.frameSize - 1 && this.currentPointer > this.frameSize - 9) this.currentPointer--;
		 else if (this.currentPointer == 9) this.currentPointer = 0;
		 else if (rowCount >= 3) if (this.currentPointer == 17) this.currentPointer = 26;
		 else if (this.currentPointer == 18) this.currentPointer = 9;
		 else if (rowCount >= 4) if (this.currentPointer == 26) this.currentPointer = 35;
		 else if (this.currentPointer == 27) this.currentPointer = 18;
		 else if (rowCount >= 5) if (this.currentPointer == 35) this.currentPointer = 44;
		 else if (this.currentPointer == 36) this.currentPointer = 27;
		 else if (rowCount == 6) if (this.currentPointer == 44) this.currentPointer = 53;
		 else if (this.currentPointer == 45) this.currentPointer = 36;
	...
	private ItemFrameClockwiseSlider(final ItemStack fillerItem, final ItemStack highlightItem) {
