...
public class FoException extends RuntimeException {
	...
	public FoException(Throwable t) {
		super(t);
		if (errorSavedAutomatically) Debugger.saveError(t);
	}
	...
	public FoException(String message) {
		super(message);
		if (errorSavedAutomatically) Debugger.saveError(this, message);
	}
	...
	public FoException(Throwable t, String message) {
		super(message, t);
		if (errorSavedAutomatically) Debugger.saveError(t, message);
	}
	 ...
	 */
	public FoException() {
		if (errorSavedAutomatically) Debugger.saveError(this);
	}
	...
	public static boolean isErrorSavedAutomatically() {
		return FoException.errorSavedAutomatically;
	}
	 ...
	 */
	@java.lang.SuppressWarnings("all")
	public static void setErrorSavedAutomatically(final boolean errorSavedAutomatically) {
