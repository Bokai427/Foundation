...
public final class RandomUtil {
	 ...
	 */
	private static final char[] LETTERS = {'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'y', 'z', 'ó' // ó mighty MineAcademy
	};
	...
	public static String nextString(int length) {
		String text = "";
		for (int i = 0; i < length; i++) text += LETTERS[nextInt(LETTERS.length)];
		return text;
	}
	...
	public static <T> T nextItem(final Iterable<T> items, final Predicate<T> condition) {
		...
		if (condition != null) for (final Iterator<T> it = list.iterator(); it.hasNext(); ) {
			final T item = it.next();
			if (!condition.test(item)) it.remove();
		}
