...
public class SimpleHologramStand extends SimpleHologram {
	...
	protected final Entity createEntity() {
		...
		if (this.itemOrMaterial instanceof ItemStack) item = ItemCreator.of((ItemStack) this.itemOrMaterial);
		 else item = ItemCreator.of((CompMaterial) this.itemOrMaterial);
