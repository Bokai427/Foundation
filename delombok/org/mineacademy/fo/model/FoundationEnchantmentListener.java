...
public final class FoundationEnchantmentListener implements Listener {
	...
	public void onEntityDamage(EntityDamageByEntityEvent event) {
		...
		if (damager instanceof LivingEntity) this.execute((LivingEntity) damager, (enchant, level) -> enchant.onDamage(level, (LivingEntity) damager, event));
	}
	...
	private void execute(LivingEntity source, BiConsumer<SimpleEnchantment, Integer> executer) {
		try {
			...
			if (hand != null) for (final Entry<SimpleEnchantment, Integer> e : SimpleEnchantment.findEnchantments(hand).entrySet()) executer.accept(e.getKey(), e.getValue());
		} catch (final NoSuchMethodError ex) {
			if (Remain.hasItemMeta()) ex.printStackTrace();
		}
	}
	...
	public static Listener getInstance() {
		return FoundationEnchantmentListener.instance;
	}
}
