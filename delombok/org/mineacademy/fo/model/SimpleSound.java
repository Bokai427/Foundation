...
public final class SimpleSound {
	...
	public SimpleSound(@NonNull String line) {
		if (line == null) {
			throw new java.lang.NullPointerException("line is marked non-null but is null");
		}
		if ("none".equals(line)) {
		...
		} else this.pitch = Float.parseFloat(pitchRaw);
	}
	...
	public void play(Iterable<Player> players) {
		if (this.enabled) for (final Player player : players) this.play(player);
	}
	...
	@java.lang.SuppressWarnings("all")
	private SimpleSound(@NonNull final Sound sound, final float volume, final float pitch, final boolean randomPitch, final boolean enabled) {
		if (sound == null) {
