...
public abstract class SimpleTrait extends Trait {
	...
	private void handleClickEvent(NPCClickEvent event, ClickType clickType) {
		...
		try {
			...
			if (ex.getMessages() != null) if (Messenger.ENABLED) Messenger.error(player, ex.getMessages());
			 else Common.tell(player, ex.getMessages());
			if (ex.isCancelled()) event.setCancelled(true);
		}
	}
	...
	@java.lang.SuppressWarnings("all")
	protected void setTickThreshold(final int tickThreshold) {
