...
public final class DiscordSender implements CommandSender {
	...
	public void sendMessage(String... messages) {
		for (final String message : messages) this.sendMessage(message);
	}
	...
	@java.lang.SuppressWarnings("all")
	public DiscordSender(final String name, @Nullable final OfflinePlayer offlinePlayer, final User user, final MessageChannel channel, final Message message) {
		this.name = name;
